...
func (m *ResourceFilter) validate(all bool) error {
	...
	if !_ResourceFilter_Type_Pattern.MatchString(m.GetType()) {
...
var _ResourceFilter_Type_Pattern = regexp.MustCompile("^[^:#@\\s]{1,50}$")
...
func (m *GetConfigurationResponse) validate(all bool) error {
	...
	// no validation rules for PolicyDecisionPoint

	// no validation rules for AccessEvaluationEndpoint

	// no validation rules for AccessEvaluationsEndpoint

	// no validation rules for SearchSubjectEndpoint
